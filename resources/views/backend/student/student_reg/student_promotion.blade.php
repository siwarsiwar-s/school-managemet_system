                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text"  name="discount" class="form-control" required=''  value="{{$editData['student']['discount']}}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="group_id"  required class="form-control">
                                                        <option value=""   {{($editData->group_id == $group->id )? "selected": ""}}>Select Group</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h5>Group<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <img id="showImage" src="{{(!empty($editData['student']['image']))? url('upload/student_images/'.$editData['student']['image'])
                                                    :url('upload/no_image.JPG')}}" style="width: 100px; width: 100px; border: 1px; solis#000000;">
                                                </div>
                                            </div>
